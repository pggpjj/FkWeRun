...
-- ----------------------------
-- Table structure for t_daka_data
-- ----------------------------
DROP TABLE IF EXISTS `t_daka_data`;
CREATE TABLE `t_daka_data` (
...
-- ----------------------------
DROP TABLE IF EXISTS `t_daka_userinfo`;
CREATE TABLE `t_daka_userinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `openid` varchar(100) NOT NULL,
