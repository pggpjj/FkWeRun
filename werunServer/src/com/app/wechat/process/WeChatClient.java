package com.app.wechat.process;

import com.app.wechat.process.vo.JsCodeSession;
import com.app.wechat.process.vo.StepListOpenid;
import com.app.wechat.process.vo.TemplateMsg;
...
public class WeChatClient {
	...
	public static String getAccessToken(String appId, String appSecret) {
		...
		JSONObject jsonObject = WeChatApi.httpsRequest(url, "GET", null);
	...
	public static void sendTemplateMsg(String appId, String appSecret, TemplateMsg msg){
		...
		WeChatApi.httpsRequest(requestUrl, "POST", msgData);
	}
